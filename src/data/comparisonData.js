export const aiComparisonData = {
  ...
  "AI Influencer Studio": [
    ...
    ["Formats produced", "Photos", "Photos, reels, voiceovers", "Multi-format"],
    [
      "Brand consistency",
      "Depends on talent",
      "100 % on-brand",
    ...
    ["Scalability", "1 model per shoot", "Many AI personas", "Infinite reach"],
  ],
...
export const headerData = {
  ...
  "AI Marketing Suite": [["Human Content Team", "Aeontrix AI Marketing Suite"]],
